          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add new user <i><?php echo (!empty($user->username)?$user->username:NULL) ;?></i></small></h2>
...
-->                  <div class="x_content">
                    <?php
                    echo form_open('admin/adduser/','id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');
                    ?>
                    ...
                    <br />
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Password Confirmation <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php 
                        $passconfform=array
                      ...
                      <div class="form-group">
                        ...
                        <?php
                          ...
                          echo form_dropdown('level',$levels,null,'class="form-control"');
                        ?>
                      ...
                      <div class="form-group">
                        ...
                        //  $user->gender=!empty($user->gender)?$user->gender:NULL;
                          ...
                          ?>
                          <?php echo form_radio('gender','m',null,$genderform) ;?> &nbsp; Male &nbsp;
                          <?php echo form_radio('gender','f',null,$genderform) ;?> &nbsp; Female &nbsp;
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <?php
                            echo anchor('admin/','Cancel','class="btn btn-success"');
                          ?>
