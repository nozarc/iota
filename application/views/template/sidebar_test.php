...
<!--                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-users"></i> Users <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('admin/viewusers'); ?>">View Users</a></li>
                      <li><a href="<?php echo base_url('admin/adduser'); ?>">Add User</a></li>
                      <li><a href="<?php echo base_url('admin/profile'); ?>">Your Profile</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-university"></i> School Data <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('admin/schooldata'); ?>">School Data</a></li>
                      <li><a href="<?php echo base_url('admin/schoolclasses'); ?>">School's Classes</a></li>
                    </ul>
                  </li>
