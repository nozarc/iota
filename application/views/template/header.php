    ...
    <!-- Font Awesome -->
    <link href="<?php echo $_tpath;?>/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet">

    <!-- iCheck -->
    <link href="<?php echo $_tpath;?>/vendors/iCheck/skins/flat/green.css" rel="stylesheet">

    <!-- bootstrap-progressbar -->
    <link href="<?php echo $_tpath;?>/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">

    <!-- jVectorMap -->
    <link href="<?php echo $_tpath;?>/css/maps/jquery-jvectormap-2.0.3.css" rel="stylesheet"/>

       <!-- Datatables -->
    <link href="<?php echo $_tpath;?>/vendors/datatables.net-bs/css/dataTables.bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo $_tpath;?>/vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo $_tpath;?>/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css" rel="stylesheet">
    ...
    <!-- Select2 -->
    <link href="<?php echo $_tpath;?>/vendors/select2/dist/css/select2.min.css" rel="stylesheet">

    <!-- Switchery -->
    <link href="<?php echo $_tpath;?>/vendors/switchery/dist/switchery.min.css" rel="stylesheet">
